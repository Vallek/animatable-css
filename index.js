...
stream.once('open', async function() {
	...
	<main class="page__main">
		...
		<div class="page__notes">
			...
			<p>Some values may differ between W3C api and any other sources (including MDN and specs themselves). Always check different sources and test it yourself!</p>
